// ============================================================================
// spl_cim_causal_unit_v2 — NOMOS Causal Audit Unit (Drop-in replacement for v1)
// ============================================================================
// Replaces magic-number detection with NOMOS-derived constraint checking.
//
// Causal Record Wire Format (packed into wr_data_p + wr_data_q):
//   wr_data_p[255:248] = rule_id           — NOMOS constraint rule hash prefix
